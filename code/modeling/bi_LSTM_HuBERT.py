...
csv_path = os.path.join(repo_root, "data", "processed", "hubert_features.csv")
...
print(f'Test Loss for Original HuBERT Features: {loss:.4f}, Test Accuracy for Original HuBERT Features: {acc:.4f}')
